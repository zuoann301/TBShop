...
{
    [Area(AreaNames.Wiki)]
    [Permission("wiki.stockin")]
    public class StockInController : WebController<IStockService>
    {
        ...
        {
            PagedData<Stock> pagedData = this.Service.GetPageData(pagination,"I", keyword);
        ...
        [Permission("wiki.stockin.update")]
        [HttpPost]
        ...
        [Permission("wiki.stockin.delete")]
        [HttpPost]
